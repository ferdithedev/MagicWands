...
public class Accio extends OBItem {
    public Accio(JavaPlugin plugin) {
        super(plugin, Material.STICK, "Accio", 10, OBItemType.WEAPON, OBItemRarity.COMMON, "§7Pulls a player towards you.");
    }
